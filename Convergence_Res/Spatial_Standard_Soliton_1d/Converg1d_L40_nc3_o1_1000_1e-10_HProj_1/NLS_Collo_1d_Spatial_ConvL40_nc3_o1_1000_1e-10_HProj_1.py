...
for index_012 in range(1):
    ...
    suffix = 'L{}_nc{}_o{}_{}_{}_HProj_{}'.format(L,n_collo,order,N_Tsteps,N_thres,ref_order)
    ...
    if order == 1:
        ...
        # N_sets = [480, 720, 960, 1200, 1440]
        N_sets = [3200,4000,4800]
    elif order == 2:
        N_sets = [240, 360, 480, 600, 720]
    elif order == 3:
