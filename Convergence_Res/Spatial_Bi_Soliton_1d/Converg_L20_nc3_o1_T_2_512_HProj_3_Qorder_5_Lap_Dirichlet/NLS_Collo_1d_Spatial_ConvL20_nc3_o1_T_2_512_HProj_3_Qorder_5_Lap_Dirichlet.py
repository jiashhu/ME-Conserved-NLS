...
for sp_order in [1,2,3]:
    ...
    print('dim = {}, n_collo = {}, order = {}, N_thres = {}, ref_order = {}, Laplace option is {}'.format(dim, n_collo,sp_order, N_thres, ref_order, Lap_opt))
    ...
    FO.Copy_Code(OriginDir='/home/jiashhu/Collocation_NLS/Implicit_Newton_Iter/',TargetDir=BaseDirPath,CodeName='NLS_Collo_1d_Spatial_Conv.py',suffix=suffix)
    ...
    for N_Spatial in N_sets:
        ...
        myObj    = CPN_Converg_1d_Focus_Newt(
            mesh, kappa = kappa, p = p, order = sp_order, 
