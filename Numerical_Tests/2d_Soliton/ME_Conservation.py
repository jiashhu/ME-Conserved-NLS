...
f_name = '/Users/hjs/Documents/2022/Collocation_NLS/Convergence_Res/ME_Conserv/ME_Local_Soliton_2d/Converg_L10_nc2_o3_T_1_64_HProj_2_Qorder_5_Lap_peri'
...
fig.savefig(os.path.join(SavePath,'{}.eps'.format('ME_ITER_Local_Soliton')),dpi=600,format='eps')
