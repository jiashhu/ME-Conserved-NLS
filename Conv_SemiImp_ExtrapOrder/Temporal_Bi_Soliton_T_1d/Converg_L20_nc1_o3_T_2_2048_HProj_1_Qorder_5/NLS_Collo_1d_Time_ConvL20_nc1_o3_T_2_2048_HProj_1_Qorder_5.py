...
N_sets_Dict = {
    ...
    'Temporal_Standard_Soliton': {
        ...
        '3': [20,25,30,35,40],
        '4': [8,12,14,16,20],
        'N': 1500, # spatial decomposition number
        'T': '1'
    },
...
for n_collo in [1]:
    ...
    BaseDirPath = '/home/jiashhu/Collocation_NLS/Conv_SemiImp_ExtrapOrder/{}_{}d/Converg_{}'.format(Conv_type,dim,suffix)
    ...
    for N_Tsteps in N_Tsteps_sets:
        ...
        myObj.IniByProj()
        myObj.Solving(myObj.PP_Pic,so=savefunc_obj)
        Res_dict = {
