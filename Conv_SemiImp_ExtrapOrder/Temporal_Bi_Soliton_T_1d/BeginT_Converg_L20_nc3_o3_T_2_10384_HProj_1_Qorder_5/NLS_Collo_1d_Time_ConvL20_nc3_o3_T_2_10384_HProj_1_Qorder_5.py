...
N_sets_Dict = {
    ...
    'Temporal_Standard_Soliton': {
        ...
        '3': [20,25,30,35,40],
        '4': [96,120],
        'N': 12000, # spatial decomposition number
        'T': '1'
    },
...
# Mesh Param
Conv_type = 'Temporal_Bi_Soliton_T'
Md_type = 'BeginT'
dim = 1
...
for n_collo in [3]:
    ...
    BaseDirPath = '/home/jiashhu/Collocation_NLS/Conv_SemiImp_ExtrapOrder/{}_{}d/{}_Converg_{}'.format(Conv_type,dim,Md_type,suffix)
    ...
    for N_Tsteps in N_Tsteps_sets:
        ...
        myObj.IniByProj()
        myObj.Solving(myObj.PP_Pic,so=savefunc_obj,Eig_opt=False)
        Res_dict = {
